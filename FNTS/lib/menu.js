...
const help = (prefix, jame, betime, blockNumber, prem, banned, cts, waver) => {
    return `
*┏━──Information Bot*
*┃Dari sekian banyak fitur, 
*┃yang masih hidup cuman segini doang. 
*┃Sisanya webnya di shutdown herokuapp 
*┃jadi api nya gabisa dipake, 
*┃pepek sekali.
*┗━──────────────*
*┃➥${prefix}s = buat stiker*
*┃➥${prefix}lirik = nyari lirik*
*┃➥${prefix}doggo = foto doggo*
*┃➥${prefix}bucin = adit*
*┃➥${prefix}tebakgambar = cem babi*
*┃➥${prefix}kusonime = wibu*
*┃➥${prefix}tts = text to sound*
*┃➥${prefix}tiktok = video tiktok*
*┃➥${prefix}memeindo = krinj *
*┃➥${prefix}daknmemes = krinj *
*┏━──Dahlah cape
*┗━──────────────*
`
}
